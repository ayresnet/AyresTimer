/*
 * AyresTimer - Ejemplo 05: Benchmark y Telemetría Completa
 *
 * Demuestra la medición de precisión, detección de jitter y control multi-timer.
 */
...
void setup() {
    ...
    Serial.println("\n============================================================");
    Serial.println("  AYRES TIMER - EJEMPLO 05: TELEMETRIA Y BENCHMARK ESP32    ");
    Serial.println("============================================================");
